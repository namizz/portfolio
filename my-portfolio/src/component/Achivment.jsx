  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl text-neutral-800 dark:text-white max-w-4xl font-bold">
          Achievements and Certificates
        </h2>
      </div>
      <div ref={ref} className={`${txt.className} relative max-w-7xl mx-auto`}>
        {data.map((item, index) => {
            ...
            >
              <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                ...
                <div className="flex-col">
                  <h3 className="hidden md:block text-xl md:pl-20 md:text-4xl font-bold text-[#213864de] dark:text-neutral-300">
                    {item.title}
                  </h3>
                  {item.images && item.images.length > 0 && (
                    ...
                    >
                      ...
                      {item.images.length > 2 && (
                        <button
                          className=" relative text-white bg-[#0000003a] rounded-md  my-auto px-1.5 text-xs right-8 border-1"
              ...
              <div className=" text-lg relative pl-20 pr-4 md:pl-4 w-full">
                ...
                {item.references && Array.isArray(item.references) && (
                  <div className="mt-4">
                    <h4 className="text-lg font-semibold text-neutral-700 dark:text-neutral-400">
                      More Detail:
                    </h4>
                    <ul className="list-disc pl-2 text-blue-500 dark:text-blue-400">
