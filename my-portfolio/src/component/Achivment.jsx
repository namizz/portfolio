        ...
        <div ref={ref} className={`${txt.className}static max-w-7xl mx-auto `}>
          {data.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className=" md:flex justify-start pt-10 md:pt-30 md:gap-10 "
              >
                <div className=" sticky flex flex-col md:flex-row z-0 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                  ...
                  <div className="flex-col">
                    <h3 className="ml-20 sm:mx-0 md:block text-2xl md:pl-20 md:text-4xl font-bold text-[#213864de]">
                      {item.title}
                    </h3>
                ...
                <div className=" text-lg pl-20 pr-4 md:pl-4 w-full">
                  <div className="flex justify-between">
                    <h3 className="block text-lg sm:text-2xl mb-4 sm:mb-8 text-left font-bold text-neutral-700 dark:text-neutral-500">
                      {item.title}
                    </h3>
                  ...
                  {item.references && Array.isArray(item.references) && (
                    <div className="mt-4">
                      ...
                      <ul className="inline-block relative z-10 list-disc pl-2 text-blue-500">
